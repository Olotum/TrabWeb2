...
<body class="m-5">
  <nav class="bg-primary d-flex justify-content-between p-3">
    <div>
      <a href="add-colab.php" class="text-white text-decoration-none">Novo Colaborador</a>
      <a href="list-colabs.html" class="text-white text-decoration-none">Lista de Colaboradores</a>
    </div>
  ...
  <main class="bg-primary card d-flex align-items-center mt-5">
    <form action="#" method="post" class="w-75 p-3">
      <label for="user_name">Nome do colaborador</label>
      <input type="text" id="user_name" name="user_name" class="form-control" required />
      <label for="user_cpf">CPF do colaborador</label>
      <input type="text" id="user_cpf" name="user_cpf" class="form-control" required />
      <label for="pc_number">Cargo do colaborador</label>
      <input type="text" id="cargo_colab" name="cargo_colab" class="form-control" required />
      <label for="setor" class="d-block">Setor</label>
      <select name="setor" id="setor" class="form-select">
        <option value="comercial">Comercial</option>
        <option value="limpeza">Limpeza</option>
        <option value="ti">TI</option>
      </select>
      <label for="nivel" class="d-block">Classificação</label>
